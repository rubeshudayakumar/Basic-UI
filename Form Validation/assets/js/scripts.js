function validate(){
    ...
    validateInput(firstName,/^[a-zA-Z]{1,30}$/g,"First Name is required","First Name is not valid","#first-name ~ .error-message");
    validateInput(lastName,/^[a-zA-Z]{1,30}$/g,"Last Name is required","Last Name is not valid","#last-name ~ .error-message");
    validateInput(email,/^[a-z][a-zA-Z0-9]+@[a-zA-Z]+\.[a-zA-Z]+$/,"Email Address is required","Email Address is not valid","#email-id ~ .error-message");
